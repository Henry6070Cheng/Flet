...
def document_create(page: ft.Page, return_content=False):
    page.title = "新建文档"
    page.window_maximized = True
    page.padding = 0
    
    def return_to_document_list(e):
        ...
        content=ft.Row(
            [
                create_breadcrumb(page, [
                    ...
                    {"text": "文档管理", "on_click": return_to_document_list},
                    {"text": "新建文档"},
                ]),
            ],
        ),
                                        ...
                                        ft.Container(
                                            content=ft.Column(
                                                [
                                                    ...
                                                    ft.Row(
                                                        [
                                                            ft.Text("文档类型", width=100),
                                                            ft.Dropdown(
                                                                width=300,
                                                                height=40,
                                                                border_color=ft.Colors.GREY_400,
                                                                options=[
                                                                    ft.dropdown.Option("技术文档"),
                                                                    ft.dropdown.Option("设计文档"),
                                                                    ft.dropdown.Option("测试文档"),
                                                                ],
                                                            ),
                                                        ],
                                                        vertical_alignment=ft.CrossAxisAlignment.CENTER,
                                                    ...
                                                    ft.Row(
                                                        [
                                                            ft.Text("项目", width=100),
                                                            ft.Dropdown(
                                                                width=300,
                                                                height=40,
                                                                border_color=ft.Colors.GREY_400,
                                                                options=[
                                                                    ft.dropdown.Option("项目A"),
                                                                    ft.dropdown.Option("项目B"),
                                                                    ft.dropdown.Option("项目C"),
                                                                ],
                                                            ),
                                                        ],
                                                        vertical_alignment=ft.CrossAxisAlignment.CENTER,
                                        ...
                                        ft.Row(
                                            [
                                                ft.ElevatedButton(
                                                    ...
                                                    on_click=return_to_document_list,
                                                ),
                                                ft.OutlinedButton(
                                                    "取消",
                                                    on_click=return_to_document_list,
